...
class CustomAJAXChat extends AJAXChat {
	...
	function initCustomConfig() {
		...
		$this->setConfig('dbTableNames', 'online', $db->prefix.'ajax_chat_online');
		$this->setConfig('dbTableNames', 'messages', $db->prefix.'ajax_chat_messages');
		$this->setConfig('dbTableNames', 'bans', $db->prefix.'ajax_chat_bans');
		$this->setConfig('dbTableNames', 'invitations', $db->prefix.'ajax_chat_invitations');
	}
