...
DROP TABLE IF EXISTS gs_ajax_chat_online;
...
DROP TABLE IF EXISTS gs_ajax_chat_messages;
...
DROP TABLE IF EXISTS gs_ajax_chat_bans;
...
DROP TABLE IF EXISTS gs_ajax_chat_invitations;
